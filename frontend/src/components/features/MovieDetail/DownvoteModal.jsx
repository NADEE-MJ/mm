...
export default function DownvoteModal({ isOpen, onClose, peopleNames, onAdd }) {
  ...
  return (
    <IOSSheet isOpen={isOpen} onClose={onClose} title="Add Downvote" modalId="downvote-modal">
