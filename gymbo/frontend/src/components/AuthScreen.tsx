    ...
    <div className="min-h-screen bg-ios-bg flex flex-col ios-fade-in">
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 safe-area-top safe-area-bottom">
        <div className="mb-10 text-center">
          ...
          <h1 className="text-ios-large-title font-bold text-ios-label">Gymbo</h1>
          <p className="text-ios-body text-ios-secondary-label mt-2">Sign in to track workouts</p>
        </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="text-ios-caption1 font-medium text-ios-secondary-label mb-2 block">Email</label>
            ...
            <div>
              <label className="text-ios-caption1 font-medium text-ios-secondary-label mb-2 block">Password</label>
              <div className="relative">
            ...
            <button type="submit" disabled={isLoading} className="w-full btn-ios-primary py-4 text-lg font-semibold mt-6">
              {isLoading ? (
                <>
